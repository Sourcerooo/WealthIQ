...
**Explicitly out of v1 scope** (do not add unless asked): portfolio valuation/charts, PDF export, additional brokers beyond IBKR + Trader's Place, trading strategies/backtesting, multi-base-currency. The retired "Sigmatic" project was the reference implementation; its tax logic was ported, its trading engine was not.
