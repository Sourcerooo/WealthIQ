...
| **1/12 acquisition-month reduction** | Applied to the **final** per-share Vorabpauschale, not to the Basisertrag | §18(1): *"vermindert sich **die Vorabpauschale** um ein Zwölftel…"* (§6.5) |
